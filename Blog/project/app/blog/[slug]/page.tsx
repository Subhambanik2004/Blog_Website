  ...
  try {
    ...
    return (
      <div className="relative">
        <Link
          href="/"
          className="absolute top-3 left-3 md:top-10 md:left-10 p-6 w-10 h-10 flex items-center justify-center rounded-full bg-stone-100 hover:bg-stone-200 shadow-lg shadow-blue-500/50 transition-all"
        >
